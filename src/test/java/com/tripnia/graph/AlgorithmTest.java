...
import com.tripnia.graph.algorithms.PathFinder;
...
public class AlgorithmTest {
    ...
    public void Should_Return_Path_Graph_One() {
        ...
        addLane("Edge_2", 0, 2, 5);
        addLane("Edge_3", 1, 2, 5);
        addLane("Edge_4", 1, 3, 14);
        addLane("Edge_5", 2, 3, 3);
        addLane("Edge_6", 2, 0, 1);


        Graph graph = new Graph(nodes, edges);
        PathFinder pathFinder = new PathFinder(graph);
        Map<String, Path> completePath = pathFinder.getTrip("Node_0", "Node_2", 7, 7, Arrays.asList("Lakes"));

        Path sourceToDestination = completePath.get("sourceToDestination");
        Path destinationToSource = completePath.get("destinationToSource");

        System.out.println(sourceToDestination.getNodes());
        System.out.println(sourceToDestination.getEdges());

        System.out.println(destinationToSource.getNodes());
        System.out.println(destinationToSource.getEdges());
